...
//Criando uma classe derivado de Animal
...
// Criandoi um array de animais
const animais = [
    new Cachorro("Rex", "Marrom", "Pastor Alemão"),
    new Gato("Mia", "Preto", "Siam~es"),
];

//Percorrendo do array e imprimindo o nome e a cor de cada animaç
